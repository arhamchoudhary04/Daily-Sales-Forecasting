...
export default function Page() {
  ...
  const chartTitle =
    mode === "compare"
      ...
      : "History (synthetic demo series)";

  return (
    <main className="container">
      <header className="header">
        <h1>Time-Series Forecasting</h1>
        <p>Zero-shot foundation model (Chronos-Bolt) vs a trained XGBoost baseline.</p>
        <p>Daily forecasts with prediction intervals, served by FastAPI.</p>
      </header>
      ...
      <footer className="footer">
        Built with FastAPI · Next.js · Chronos-Bolt · XGBoost. Data is a synthetic
        daily series generated by the backend.
      </footer>
    </main>
  );
}
